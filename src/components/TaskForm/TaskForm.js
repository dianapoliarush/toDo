...
const TaskForm = (props) => {
  ...
  const passTaskDataHandler = (event) => {
    event.preventDefault();
    props.onAdd(taskName);
    setTaskName("");
  };
  return (
    <form className="task-form" onSubmit={passTaskDataHandler}>
      ...
      <div className="task-form__btns">
        <button className="task-form__btn" onClick={props.onChooseAllTasks}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="16"
            width="16"
        ...
        <button className="task-form__btn" onClick={props.onDeleteAllTasks}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="16"
            width="14"
